...
if __name__ == '__main__':
    ...
    obs = Hamiltonian([1, 1], [PauliObservable("ZIIIIIIIIIII"), PauliObservable("ZZIIIIIIIIII")], 12)
    hamiltonian = MolecularHamiltonian(12, "sto-3g", "lithium-hydride")
    ...
    N = 200
    qswift = QSwift(obs, initializer, t=t, N=N, K=2, nshot=0, n_p=10000, tool="qulacs-gpu")
